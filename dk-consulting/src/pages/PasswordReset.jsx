        ...
        <div className="w-[860px] h-[max-content] bg-[#0A0B22] flex flex-col items-center py-[50px] relative lg:w-[680px] md:w-[680px] md:py-30px sm:w-[410px] sm:py-5 xs:w-[290px] xs:py-5">
          ...
          {msgVisible ? (
            ...
            <div className="flex flex-col items-center">
              ...
              >
                <h2 className="text-white text-[40px] text-center leading-[56px] font-extralight lg:text-4xl md:text-4xl md:mt-[25px] sm:mt-5 sm:text-xl sm:uppercase xs:uppercase xs:text-lg  xs:mt-4">Восстановление пароля</h2>
                <input
                  type="email"
                  placeholder="Email"
                  value={email}
                ...
                ></input>
                <Button bluebtn="true" buttonText="Сбросить пароль" type="submit">Сбросить пароль</Button>
              </form>
            </div>
          )}
        </div>
