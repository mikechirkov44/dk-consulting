...
export const FormComponent = React.forwardRef((props, forwardedRef) => {
    ...
    const submit = (e) => {
        ...
        if (email !== "" && phone !== "") {
            ...
            setMessage(
                "Вы заполнили не все данные, проверьте и попробуйте еще раз"
            );
            setTimeout(() => {
                setMsgVisible(false);
            }, "3000");
    ...
    return (
        <>
            <section
                {...props}
                ref={forwardedRef}
                className="py-[88px] max-w-[1290px] mx-auto  lg:max-w-[940px] md:max-w-[690px] sm:max-w-[420px] xs:max-w-[290px]"
            >
                ...
                >
                    <ul className="flex justify-between items-center text-[#5A5656] w-[100%] mb-[32px] flex-wrap md:space-y-2 md:mb-5 sm:space-y-2 sm:mb-5 xs:flex-col xs:items-start xs:space-y-2">
                        <li className="flex items-center md:w-[50%] sm:w-[50%]">
                            <input
                                ...
                                value="AUDIT"
                                id="audit"
                                className="w-7 h-7 lg:w-6 lg:h-6 md:h-5 md:w-5 sm:h-4 sm:w-4 xs:h-4 xs:w-4"
                                onClick={() => {
                                    subjectChange("AUDIT");
                                }}
                            />
                            <label
                                htmlFor="audit"
                                className="font-light text-[22px] leading-[30px] ml-[10px] md:text-lg sm:text-sm sm:ml-1 xs:text-sm xs:ml-1"
                            >
                                Аудит
                            </label>
                        </li>
                    ...
                    <ul className="flex flex-col w-[100%]">
                        <li className="flex flex-col">
                            <label
                                htmlFor="name"
                                className="text-[#4D8BBE] text-[22px] leading-[30px] font-normal md:text-lg sm:text-sm xs:text-sm"
                            >
                                Ваше имя
                            </label>
                            <input
                                ...
                                className="px-2 w-[100%] border-b-[1px] border-black mt-[4px] text-[#40454E] font-light text-[22px] leading-[30px] mb-[30px] py-1 md:text-lg sm:text-sm sm:mb-5 sm:mt-3 xs:text-sm xs:mb-4 xs:mt-2"
                            />
                        </li>
                        <li className="flex flex-col">
                            <label
                    ...
                    <div className="flex flex-col w-[100%] mb-10">
                        <div>
                            {" "}
                            <p className="text-[#4D8BBE] text-[22px] leading-[30px] font-normal md:text-lg sm:text-sm xs:text-sm">
                                Как вы узнали о нас?
                            </p>
                        </div>
            ...
            className={
                msgVisible
                    ? "bg-[rgba(0,0,0,0.5)]  fixed z-[1000] top-0 w-[100vw] h-[100vh] flex flex-col items-center justify-center"
                    : "hidden"
            }
        >
            <div className="bg-white p-8 relative flex flex-col items-center  justify-center w-[700px] h-[400px] sm:w-[320px] sm:h-[250px] xs:w-[320px] xs:h-[250px]">
                <button
                    className="absolute right-[30px] top-[30px] sm:top-4 sm:right-4"
                    onClick={() => {
                        setMsgVisible(false);
                    }}
                >
                ...
                <h2 className="max-w-[474px] text-4xl font-light text-center sm:text-lg xs:text-lg">{message}</h2>
                <div className="w-32 mt-10 sm:w-18 xs:w-18 sm:mt-6 xs:mt-6">
